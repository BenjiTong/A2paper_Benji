...
def native_handle_sqs(event, context):
    ...
    for record in records:    
        ...
        if url.__contains__('/201211/') or url.__contains__('/201209/') or url.__contains__('/201210/') or url.__contains__('/201208/') or url.__contains__('/201209/') or url.__contains__('/201204/') or url.__contains__('/201205/') or url.__contains__('/201206/') or url.__contains__('/201207/'):
