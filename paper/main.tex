...
\usepackage[backend=bibtex,doi=true, natbib=true ]{biblatex}
...
\begin{abstract}
This document is the description about the solution of Assignment 2 of Compx527 paper in Waikato University. World Bank Nightime Light Data consists of a lot of satellite imagery from the Visible Infrared Imaging Radiometer Suite Day-Night Band (VIIRS DNB) from 2012-2020. We choose 3 specific areas all over the world and focus on the imagery of these places. From these imagery, we can learn the trend of their radiance in the period. Some articles shows that the night light represents the development in the same area. We can preview the economic development of areas by the trend. 
\end{abstract}
...
A lot of things are depended by our project. It is important that imagery from AWS open datasets has almost not processed too much before storing. So we have to spend too much time on the data. To ensure our project development, we use Lark, which is a kind of instant messenger in China used in office, to record documents and communicate in a group. A sumary about our solution is shown as below.
...
\subsection{ansible}
Ansible is a famous open source deployment platform. Most of services in AWS can be working rightly with Ansible. We used it for our main sctructure deployment.
