...
public class HttpsUtil {
    ...
    public InputStream doGet(String url, Map<String, String> queryParams,Map<String,String> headerParams) throws URISyntaxException, ClientProtocolException, IOException{
        HttpResponse response= this.doGetByHeader(url, null,headerParams);
        return response!=null ? response.getEntity().getContent() : null;
    }
    ...
    public String doGetForStringByHeader(String url,Map<String,String> header) throws URISyntaxException, ClientProtocolException, IOException{
        return HttpsUtil.readStream(this.doGet(url,null,header), null);
    }
    ...
    public HttpResponse doGetByHeader(String url, Map<String, String> queryParams,Map<String,String> headerParams) throws URISyntaxException, ClientProtocolException, IOException{
        HttpGet gm = new HttpGet();
        ...
        System.out.println(Arrays.toString(gm.getHeaders("Authorization")));
        URIBuilder builder = new URIBuilder(url);
        //填入查询参数
        if (queryParams!=null && !queryParams.isEmpty()){
            builder.setParameters(HttpsUtil.paramsConverter(queryParams));
